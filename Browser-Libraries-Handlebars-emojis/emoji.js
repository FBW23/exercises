...
// ask for template
const ulTemplate = document.querySelector('#ul-template').innerHTML;
// precompile Template with Handlebars
const precompiledTemplate = Handlebars.compile(ulTemplate);

// put template and data together
// where the magic happens :D 
const theCompiledUl = precompiledTemplate(emojis);

// put the output inside the DOM 
