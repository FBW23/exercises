const integerM = [a = 111, b = 111.8, c = 10, d = 19, e = 4, f = 65, g = 39, h = 100, i = 40, j = 0, k = 12, l = 4, m = 12, n = 15, int1 = 70, int2 = 2, int3 = 5, int4 = 5, number = 20];
for (var x = 0; x < integerM.length;x++);
var is = Number.isInteger(integerM[x]);
console.log(is);
if (!is) {
