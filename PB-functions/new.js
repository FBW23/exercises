...
cubes = (a,b,c)=>{
    ...
    return Math.pow(a,3) + Math.powb(b,3);
}else if(a || b){
    return Math.pow(a,3);
}else{
    return 0;
...
stringCheck=(string1, string2)=>{
    if(string1.includes(string2)===string2.includes(stringCheck)){
        return true;
    }else{
        return false;
    }
...
const stringCheck2= stringCheck('bu', 'button');
...
const addition2= addition(3);
console.log(addition2);

isEven=(nums)=> nums%2==0;
