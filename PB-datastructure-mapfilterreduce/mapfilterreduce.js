// #### 1. Increment by 1
// Given an array of numbers, e.g. ```javascript let arrayOfNumbers = [3, 45, 6, 56, 7, 9]; ``` , create a function 
...
const completeName = array => array.map(x => x.first + ' ' + x.last);
console.log(completeName(inventors));
...
const squareRoot = array => array.map(x => Math.sqrt(x));

console.log(squareRoot([4, 25, 9]));
