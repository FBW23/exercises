...
let numArr = [9, 25, 49, 900];
let squareRoot = numArr.map(array => Math.sqrt(array));
console.log("Task 5")
...
// 8. Filter Evens
// Write a function called filterEvens that uses the filter method to filter an array and only return 
//the even numbers. The function should take in an array of numbers as an argument, and should not use a loop.
// Examples:
