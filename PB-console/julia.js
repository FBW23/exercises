...
let fourthString = 'exercice';

let fifthString = 'in';

let sixthString = 'console';

let seventhString = 'logging';

let eighthString = '"';

let myString = eighthString + ' ' + firstString + ' ' + secondString + ' ' +  thirdString + ' ' + fourthString + ' ' + fifthString + ' ' + sixthString + ' ' +  seventhString + ' ' + eighthString;
