...
// 1. dataset of quotes and their authors
  const quotesPool = [["Our greatest weakness lies in giving up. The most certain way to succeed is always to try just one more time."],
...
//Show new quote and change color scheme on 'Random Quote' button click(not working...wonder why!?)
...
// Get the first quote and color scheme on window load(not working either)
