// In one night, a movie theater sells tickets for 6450 dollars. Each ticket costs 15 dollars. How many tickets were sold?
let a=6450;
let b=15;
...
let work=8+6+5+9+8+2+1+8.5+7+4;
let average=10;
console.log (work/average)
...
let score=75+70+85+90+100
let medium=85
let x=6
let z=medium*x-score
console.log(z)
...
let av=78*8
let test=9
//let degree=(av+result)/test
// degree*test=av+result
//degree*test-av=result
let result=degree*test-av;
console.log(result)