...
isPalindrome=(MyString)=>{
    ...
    let reverse=isPalindrome(lowerCase.charAt(-1));
    console.log(reverse)
...
// 7. Also this is a bigger problem, so please watch this video first to understand the problem: https://www.youtube.com/watch?v=U9qU20VmvaU Analytical solution
